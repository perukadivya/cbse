...
export const subjects: Subject[] = [
    ...
    },
    {
        ...
        books: [
            {
                bookName: 'తెలుగు వాచకం (Telugu Textbook)',
                chapters: [
                    { id: 'tel-1', name: 'అమ్మ – ఓ అమ్మ', keyTopics: ['అమ్మ ప్రేమ', 'కవిత్వం', 'భావ వ్యక్తీకరణ'] },
                    { id: 'tel-2', name: 'శ్రీకృష్ణ రాయబారం', keyTopics: ['మహాభారతం', 'శ్రీకృష్ణుడు', 'రాయబారం', 'ధర్మం'] },
                    { id: 'tel-3', name: 'ఆత్మకథ', keyTopics: ['స్వీయ చరిత్ర', 'జీవిత అనుభవాలు', 'సాహిత్యం'] },
                    { id: 'tel-4', name: 'భాగ్యనగరం', keyTopics: ['హైదరాబాద్ చరిత్ర', 'సంస్కృతి', 'చారిత్రక ప్రాముఖ్యత'] },
                    { id: 'tel-5', name: 'దేశ భక్తి గీతాలు', keyTopics: ['జాతీయ భావం', 'స్వాతంత్ర్య పోరాటం', 'దేశప్రేమ'] },
                    { id: 'tel-6', name: 'వ్యాకరణం – సంధులు', keyTopics: ['అచ్ సంధి', 'హల్ సంధి', 'విసర్గ సంధి', 'సంధి నియమాలు'] },
                    { id: 'tel-7', name: 'వ్యాకరణం – సమాసాలు', keyTopics: ['తత్పురుష', 'ద్వంద్వ', 'బహువ్రీహి', 'కర్మధారయ'] },
                    { id: 'tel-8', name: 'వ్యాకరణం – అలంకారాలు', keyTopics: ['ఉపమ', 'రూపకం', 'ఉత్ప్రేక్ష', 'శ్లేష'] },
                    { id: 'tel-9', name: 'పద్య భాగం', keyTopics: ['ఛందస్సు', 'పద్య రచన', 'ప్రాచీన కవిత్వం'] },
                    { id: 'tel-10', name: 'వ్యాసం – లేఖ రచన', keyTopics: ['వ్యాస రచన', 'లేఖా రచన', 'సారాంశం', 'భావ విస్తరణ'] },
                ],
            },
        ],
    },
